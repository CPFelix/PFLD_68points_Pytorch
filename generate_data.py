...
class DataSet(Dataset):
    ...
    def __init__(self, file_list, img_path, image_channels, image_size, transforms=None,
    ...
    def __getitem__(self, index):
        ...
        full_file_name = os.path.join(self.img_path, file_name)
        image = self.loader(full_file_name)
...
def gen_data(file_list):
    ...
    for line in lines:
        ...
        landmark = np.asarray(line[1:43], dtype=np.float32)
        attribute = np.asarray(line[43:], dtype=np.int32)
