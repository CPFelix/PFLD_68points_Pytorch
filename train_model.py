...
def main(args):
    ...
    train_img_path = "/home/chenpengfei/dataset/hand_labels/manual_train/images"
    test_img_path = "/home/chenpengfei/dataset/hand_labels/manual_test/images"
    train_dataset = DataSet(args.file_list, train_img_path, args.image_channels, args.image_size, transforms=train_data_transforms,
                            is_train=True)
    test_dataset = DataSet(args.test_list, test_img_path, args.image_channels, args.image_size, transforms=test_data_transforms,
                           is_train=False)
    ...
    model = MobileNetV2(num_of_channels=num_of_channels, nums_class=42)  # model
    ...
    for epoch in range(args.max_epoch):
        ...
        for i_batch, (images_batch, landmarks_batch, attributes_batch) in enumerate(train_loader):
            ...
            loss = wing_loss(landmarks_batch.to(device), pre_landmarks)
